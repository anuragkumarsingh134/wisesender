 <div class="tab-pane fade  " id="sendbutton" role="tabpanel">
     ...
     <p>Endpoint: <code><?php echo e(env('APP_URL')); ?>/send-button</code></p>
     ...
     <table class="table">
         ...
         <tbody>
             ...
             <tr>
                 ...
                 <td>array</td>
                 <td>Yes</td>
                 <td>Button array ,min 1 max 5</td>
             </tr>
             <tr>
                 <td>footer</td>
                 <td>string</td>
                            ...
                            <code class="json">
 {
     ...
     <pre class="bg-dark text-white">
                            <code class="json">
    <?php echo e(env('APP_URL')); ?>/send-button?sender=6281284838163&api_key=yourapikey&number=082298859671&url=&footer=optional&message=Halo,ini pesan button&button=button 1,button 2,button 3 
    </code>
                        </pre>


 </div>
<?php /**PATH /home/wapisend/my.wapisender.com/resources/views/pages/api-docs/send-button.blade.php ENDPATH**/ ?>