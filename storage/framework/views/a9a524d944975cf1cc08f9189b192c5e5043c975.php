<div class="tab-pane fade show active" id="sendmessage" role="tabpanel">
    ...
    <p>Endpoint: <code><?php echo e(env('APP_URL')); ?>/send-message</code></p>
    ...
    <pre class="bg-dark text-white">
        <code class="json">
<?php echo e(env('APP_URL')); ?>/send-message?api_key=1234567890&sender=62888xxxx&number=62888xxxx&message=Hello World
        </code>
      </pre>


</div>
<?php /**PATH /home/wapisend/my.wapisender.com/resources/views/pages/api-docs/send-message.blade.php ENDPATH**/ ?>