...
<?php endif; ?>
    ...
    <div class="ms-auto my-4 items-end">
        <div class="btn-group">
            <form action="<?php echo e(route('fetch.groups')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="device"
                    value="<?php echo e(Session::has('selectedDevice') ? Session::get('selectedDevice')['device_id'] : ''); ?>">
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/wapisend/my.wapisender.com/resources/views/pages/phonebook/index.blade.php ENDPATH**/ ?>