<div class="tab-pane fade " id="sendtemplate" role="tabpanel">
    ...
    <p>Endpoint: <code><?php echo e(env('APP_URL')); ?>/send-template</code></p>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>array</td>
                <td>Yes</td>
                <td>array of button template Min 1 Max 3</td>
            </tr>
        </tbody>
    </table>
    <br>
                            ...
                            <code>
 {
    ...
    <pre class="bg-dark text-white p-3">
                            <code>
<?php echo e(env('APP_URL')); ?>/send-template?sender=6282298859671&api_key=ndUJR38JkvyCfLZ&number=082298859671&url=&footer=optional&message=Halo,ini pesan TEMPLATE button&template=call|template 1|082298859671,url|tempate 2|google.com
                            </code>
                        </pre>
</div>
<?php /**PATH /home/wapisend/my.wapisender.com/resources/views/pages/api-docs/send-template.blade.php ENDPATH**/ ?>