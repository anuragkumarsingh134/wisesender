                ...
                <div class="col-12 col-lg-4 mx-auto">
                    <div class="card shadow rounded-5 overflow-hidden">
                        <div class="card-body p-4 p-sm-5">
                            ...
                            <p class="card-text mb-5">Hi, welcome to WISENDER.</p>
...
unset($__errorArgs, $__bag); ?>
                                     ...
                                     <div class="col-12">
                                        ...
                                        <div class="ms-auto position-relative">
                                            ...
                                            <input type="text"
                                                class="form-control radius-30 ps-5 <?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>"
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-12">
                                        <p class="mb-0">Already have account? <a
                                                href="<?php echo e(route('login')); ?>">Sign in
                                                here</a></p>
                                    </div>
                                </div>
                            </form>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/wapisend/my.wapisender.com/resources/views/auth/register.blade.php ENDPATH**/ ?>