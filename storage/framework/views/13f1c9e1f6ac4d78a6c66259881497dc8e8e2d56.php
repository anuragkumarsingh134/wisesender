                                ...
                                <div id="step-1" class="tab-pane" role="tabpanel" aria-labelledby="step-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="campaignName" name="sender"
                                            ...
                                            value="<?php echo e(session('selectedDevice')['device_body']); ?>" disabled>
                                        <input type="hidden" name="device_id" id="device_id"
                                            value="<?php echo e(session('selectedDevice')['device_id']); ?>">
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH /home/wapisend/my.wapisender.com/resources/views/pages/campaign/create.blade.php ENDPATH**/ ?>