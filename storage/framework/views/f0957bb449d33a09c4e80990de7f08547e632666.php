<div class="tab-pane fade " id="sendlist" role="tabpanel">
    ...
    <p>Endpoint: <code><?php echo e(env('APP_URL')); ?>/send-LIST</code></p>
                            ...
                            <code>
{
    ...
    <pre class="bg-dark text-white p-3">
                            <code> 
<?php echo e(env('APP_URL')); ?>/send-list?sender=6282298859671&api_key=ndUJR38JkvyCfLZ&number=082298859671&name=pesan list&footer=optional&title=title list&buttontext=ey&message=Halo,ini pesan list&list=sdf,list2,list3
                            </code>
                        </pre>
    <br>
    
</div>
<?php /**PATH /home/wapisend/my.wapisender.com/resources/views/pages/api-docs/send-list.blade.php ENDPATH**/ ?>